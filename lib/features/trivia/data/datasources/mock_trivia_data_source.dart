...
import 'trivia_remote_data_source.dart';

/// In-memory [TriviaRemoteDataSource] for offline development and tests.
///
/// Mirrors the host-authoritative / Firestore semantics closely enough to
/// exercise the full game loop: per-session broadcast streams, an atomic
/// [updateSession] (trivially atomic here since everything runs on one
/// isolate), and invite-code lookup.
class MockTriviaDataSource implements TriviaRemoteDataSource {
